...
class WindTurbine:
  ...
  def economic_analysis(self,
    ...
    where :math:`\tau_{sv}` is the resale rate of the wind turbines in [decimal] and :math:`T_{\text{remaining}}` is the remaining lifetime of the wind turbines in time intervals.
